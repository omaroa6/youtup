...
<div class="video_detail_box">
    <div class="thumbnail_box">
      ...
      <a href="DownloadThumbnail.php?url=<?php echo $thumbnail; ?>&name=<?php echo $title; ?>" id="img_download_btn"><i class='bx bxs-download'></i></a>
         ...
         <div class="text_info">
            ...
            ?>
             ...
             <tr>
                 ...
                 <td><a href="DownloadVideo.php?link=<?php echo urlencode($url)?>&title=<?php echo urlencode($title)?>&type=<?php if($format->mimeType) echo explode(";",explode("/",$format->mimeType)[1])[0]; else echo "mp4";?>" id="download_btn"><i class='bx bxs-download'></i>&nbsp;Download</a></td>
             </tr>
